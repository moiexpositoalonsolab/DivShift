...
def main(args, save_dir, log_dir, da):
    ...
    if global_rank == 0:
        log_writer = None if args.testing else SummaryWriter(log_dir=log_dir)
    else:
        log_writer = None
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        misc.save_model(
                ...
                loss_scaler=loss_scaler, epoch=epoch, save_dir=save_dir, da=da)
