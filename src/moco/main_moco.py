...
parser.add_argument(
    "--exclude-supervised", action="store_true", help="whether to use supervised obs for training or not"
)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dataset == "DivShift":
        train_dataset = moco.moco_divshift_dataset.DivShiftPretrainDataset(args.data_dir, args.aug_plus, args.exclude_supervised)
...
def train(train_loader, model, criterion, optimizer, epoch, args, tb_writer, j):
